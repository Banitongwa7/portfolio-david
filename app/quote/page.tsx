...
export default function Quote() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-4 transition duration-300">
      <div className="w-1/2 py-20 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 transform transition duration-500 hover:scale-[1.01] hover:shadow-cyan-500/50 dark:hover:shadow-teal-400/30 border border-gray-200 dark:border-gray-700">
        ...
        <figure className="text-center">
          ...
          <blockquote className="relative">
            ...
            <p className="text-xl md:text-2xl font-serif text-gray-900 dark:text-gray-50 leading-relaxed italic">
              {`“${quote.quote}”`}
            </p>
            {/* Decorative quote marks */}
            <span className="absolute top-[-10px] left-0 text-5xl font-extrabold text-cyan-300/30 dark:text-teal-500/30">“</span>
            <span className="absolute bottom-[-10px] right-0 text-5xl font-extrabold text-cyan-300/30 dark:text-teal-500/30">”</span>
          </blockquote >
